...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="projects/:projectId/requirement-analysis" element={<ProjectDetail />} />
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="projects/:projectId/requirement-analysis" element={<UnprefixedBoardRedirect />} />
